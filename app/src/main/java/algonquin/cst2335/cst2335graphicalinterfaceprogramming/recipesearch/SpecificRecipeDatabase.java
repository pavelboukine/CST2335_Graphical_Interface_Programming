 ...
 */
@androidx.room.Database(entities = {SpecificRecipe.class}, version = 1)
public abstract class SpecificRecipeDatabase extends RoomDatabase {
    /**
     ...
     */
    public abstract SpecificRecipeDao specificRecipeDao();
}
